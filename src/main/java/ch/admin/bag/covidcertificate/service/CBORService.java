...
public class CBORService {
    ...
    // Protected Header
    @Value("${light-certificate-generation-service.cose.key-identifier}")
    ...
    public byte[] getPayload(byte[] hcert, Instant expirationInstant) {
        ...
        cborObject.set(EXP_CLAIM_KEY, instantConverter.ToCBORObject(expirationInstant));
